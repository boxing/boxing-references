...
describe('filter', () => {
  test('should filter by artist', () => {
    ...
    wrapper
      .find('input')
      .simulate('change', { target: { name: 'text', value: 'SnOop Dogg' } });
    expect(
      findTableCellThatContains(wrapper, 'Snoop Dogg').length
    ).toBeGreaterThanOrEqual(1);
  ...
  test('should filter by song', () => {
    ...
    wrapper
      .find('input')
      .simulate('change', { target: { name: 'text', value: 'Bitch PLease' } });
    expect(
      findTableCellThatContains(wrapper, 'Bitch Please').length
    ).toBeGreaterThanOrEqual(1);
  ...
  test('should filter by lyrics', () => {
    ...
    wrapper
      .find('input')
      .simulate('change', { target: { name: 'text', value: 'Beat the beaT' } });
    expect(
      findTableCellThatContains(wrapper, 'Surf Swag').length
    ).toBeGreaterThanOrEqual(1);
  ...
  test('should filter by boxers', () => {
    ...
    wrapper
      .find('input')
      .simulate('change', { target: { name: 'text', value: 'lisTon' } });
    expect(
      findTableCellThatContains(wrapper, 'Sonny Liston').length
    ).toBeGreaterThanOrEqual(1);
...
describe('no filter', () => {
  describe('song', () => {
    test('should return results', () => {
      wrapper
        .find('input')
        .simulate('change', { target: { name: 'text', value: 'surf' } });
      expect(
        findTableCellThatContains(wrapper, 'Surf Swag').length
      ).toBeGreaterThanOrEqual(1);
    });
  ...
  describe('boxer name', () => {
    test('should return results regardless of case', () => {
      wrapper
        .find('input')
        .simulate('change', { target: { name: 'text', value: 'mIke Tyson' } });
      expect(
        findTableCellThatContains(wrapper, 'Mike Tyson').length
      ).toBeGreaterThanOrEqual(1);
    });
  });
});
